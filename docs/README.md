...
* **Phase 1 complete** — receiver skeleton builds clean (0 clippy lints / 0 warnings), 17 unit tests pass,
  GTK4/libadwaita app runs on Wayland with device-list empty state, session FSM, structured `tracing` logs,
...
* Next: **Phase 2** — mDNS + manual discovery, QUIC/TLS transport, pairing handshake, `tools/mock-phone`.
